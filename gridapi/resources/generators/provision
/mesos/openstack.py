...
class openstack_provision_mesos_generator(object):
    ...
    def copy_templates(self):
        os.system('cp -a -f gridapi/resources/templates/provision/mesos/openstack/* result/{}'.format(self.grid_name))
            ...
            for module in json_data['modules']:
                for resource, value in module['resources'].iteritems():
                    if value['type'] == 'openstack_compute_instance_v2':
                        host = '{}.node.{}'.format(value['primary']['attributes'][
                                'name'], self.grid_name)
