...
gceconfig_parser.add_argument('sshkeydata', required=True,
...
gce_infrastructure_deployment_parser.add_argument(
    'parallelism', type=int, default=5, help='Terraform deployment threads')
gce_infrastructure_deployment_parser.add_argument(
    'credentials', required=True, help='GCE credentials file, URL encoded')
...
gcegroup_parser.add_argument('cpus', required=True, type=int,
                          help='Number of CPUs in group')
gcegroup_parser.add_argument('ram', required=True, type=int,
                          help='Amount of RAM in group, in GB')
gcegroup_parser.add_argument('disk_size', required=True, type=int,
                          help='Slave disk size(per slave), in GB')
gcegroup_parser.add_argument(
    'customhwconf',
    help='Add custom hardware configuration to slaves, escaped JSON format')
gcegroup_parser.add_argument('instance_type', default='n1-standard-2',
                             help='GCE Instance type, by default n1-standard-2')
gcegroup_parser.add_argument('zone', help='Zone to place group to')
gcegroup_parser.add_argument('preemptible', type=bool, default=False,
